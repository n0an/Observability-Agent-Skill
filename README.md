...
- **Log retrieval** - Console.app filtering and saved searches, the `log` CLI (`stream`/`show`/`collect`/`config` with predicate recipes), logging configuration profiles, sysdiagnose capture, the Xcode 15+ structured console
